...
impl Parser {
    ...
    fn ty(&mut self) -> Result<Ty> {
        ...
        let kind = match ident.as_ref() {
            "i8" => TyKind::Int(IntTy::Signed(SignedIntTy::I8)),
            "i16" => TyKind::Int(IntTy::Signed(SignedIntTy::I16)),
            "i32" => TyKind::Int(IntTy::Signed(SignedIntTy::I32)),
            "i64" => TyKind::Int(IntTy::Signed(SignedIntTy::I64)),
            "u8" => TyKind::Int(IntTy::Unsigned(UnsignedIntTy::U8)),
            "u16" => TyKind::Int(IntTy::Unsigned(UnsignedIntTy::U16)),
            "u32" => TyKind::Int(IntTy::Unsigned(UnsignedIntTy::U32)),
            "u64" => TyKind::Int(IntTy::Unsigned(UnsignedIntTy::U64)),
            "Bool" => TyKind::Bool,
            "Str" => TyKind::Str,
            _ => TyKind::Var(ident),
        };
